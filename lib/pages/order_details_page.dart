...
import 'package:farmersmarket/utils/deliveryDate.dart';
...
class OrderDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppConstants.order_details),
      ),
      body: ListView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(AppConstants.delivery_estimate),
                      Text(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(AppConstants.payment_method),
                      Text(
                        "Credit Card **1234",
